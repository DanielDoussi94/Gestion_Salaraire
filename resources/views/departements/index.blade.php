							    ...
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tr>
											...
											<td class="cell"> <a class="btn-sm app-btn-secondary" href="{{route('departement.edit', $departement->id)}}">Editer</a> <a class="btn-sm app-btn-secondary" href="{{route('departement.delete',$departement)}}">Supprimer</a></td>
										</tr>
                                        @empty   
                                        <tr>
