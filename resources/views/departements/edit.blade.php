...
<h1 class="app-page-title">Departements</h1>
	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" action="{{route('departement.update', $departement->id)}}" method="POST">
									@csrf
									@method('PUT')
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="text" class="form-control" id="setting-input-1"  name="name" placeholder="Entrer le nom" value = "{{$departement->name}}" required>
									@error('name')
									{{$message}}
									@enderror
									</div>
