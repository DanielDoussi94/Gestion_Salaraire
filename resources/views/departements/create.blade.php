...
<h1 class="app-page-title">Departements</h1>
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Ajouter  nouveau Departement</div>
	                </div>
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    
						    <div class="app-card-body">
							    <form class="settings-form" action="{{route('departement.store')}}" method="POST">
									@csrf
									@method('POST')
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="text" class="form-control" id="setting-input-1"  name="name" placeholder="Entrer le nom"  value = "{{old('name')}}" required>
